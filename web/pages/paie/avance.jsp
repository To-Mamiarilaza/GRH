...
<%@page import="model.paie.avance.Avance, java.util.List" %>

<%
    int idEmploye = (int) request.getAttribute("idEmploye");
    List<Avance> avances = (List<Avance>) request.getAttribute("avances");
    
    int mois = (int) request.getAttribute("mois");
    int year = (int) request.getAttribute("year");
    
    double montantPossible = (double) request.getAttribute("montantPossible");
%>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <h4 class="card-title">DEMANDE D'AVANCE</h4>
                <div class="row">
                    <div class="col-md-8">
                        <p class="text-small color-primary m-0">Montant possible :<span class="font-weight-bold mx-3"><%= montantPossible %> Ar</span></p>
                        <form action="./Avance" method="GET" class="mt-3">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%= avance.getDate() %></td>
                                    <td><%= avance.getMontant() %> AR</td>
                    ...
                    <div class="col-md-4 paie-element-insertion">
                        <h4 class="color-primary">Demande d'avance</h4>
