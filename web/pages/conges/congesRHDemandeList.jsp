            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    <div class="action-conges d-flex">
                        ...
                        <div class="mx-4">
                            <a href="./CongesRHDemandeList?demande=1" class="btn btn-gradient-primary btn-sm same-width"> Demande de conges </a>
                        </div>
                        <div class="mx-4">
                            <a href="./CongesRHDemandeList?refuse=1" class="btn btn-gradient-primary btn-sm same-width"> Conges refuse </a>
                        </div>
                        <div class="mx-4">
                            <a href="./CongesRHDemandeList?valide=1" class="btn btn-gradient-primary btn-sm same-width"> Conges valide</a>
                        </div>
                        <div class="mx-4">
                            <a href="./CongesRHDemandeList?current=1" class="btn btn-gradient-primary btn-sm same-width"> Conges en cours</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <% for(Conge conge: congeList) { %>
                                    <tr>
                                        ...
                                        <td><a href="./CongesRHDemandeDetail?idConge=<%= conge.getIdConge() %>"><i
