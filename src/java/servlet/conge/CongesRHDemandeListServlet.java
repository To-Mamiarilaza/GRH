 ...
 */
@WebServlet(name = "CongesRHDemandeListServlet", urlPatterns = {"/CongesRHDemandeList"})
public class CongesRHDemandeListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("RH_DEPARTEMENT", "Ressources humaines");
            ...
            request.setAttribute("contentPage", "./pages/conges/congesRHDemandeList.jsp");
