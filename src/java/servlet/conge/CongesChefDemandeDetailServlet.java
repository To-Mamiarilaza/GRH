 ...
 */
@WebServlet(name = "CongesChefDemandeDetailServlet", urlPatterns = {"/CongesChefDemandeDetail"})
public class CongesChefDemandeDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("contentPage", "./pages/conges/congesChefDemandeDetail.jsp");
